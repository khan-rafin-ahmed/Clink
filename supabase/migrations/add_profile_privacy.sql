...
-- Add profile privacy fields to user_profiles table
ALTER TABLE user_profiles 
ADD COLUMN profile_visibility TEXT DEFAULT 'public' CHECK (profile_visibility IN ('public', 'crew_only', 'private')),
