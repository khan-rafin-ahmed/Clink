-- Add event ratings functionality
-- This migration creates the event_ratings table for post-event star ratings
...
CREATE INDEX event_ratings_rating_idx ON event_ratings(rating);
CREATE INDEX event_ratings_created_at_idx ON event_ratings(created_at);
...
-- Create a function to calculate average rating for an event
...
-- Create a function to check if user can rate an event
...
-- Add notification type for rating reminders
